...
genetic.configuration.size = 100;
genetic.configuration.crossover = 0;
genetic.configuration.mutation = 0.0004870242;
genetic.configuration.iterations = 2000;
...
genetic.mutate = function(entity) {
    ...
    function replaceBinary(bin){
       return bin = 0 ? 1: 0;
    }
	
	// chromosomal drift
	var i = Math.floor(Math.random()*entity.length)
    let answ = replaceAt(entity, i, replaceBinary(entity[i]));
    console.log(answ);
	return answ;
};
